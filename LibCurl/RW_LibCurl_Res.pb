...
;{ Structures }
  Structure Curl_HTTPPost
    ...
    *name.s             ; Ptr to allocated name 
    namelength.l        ; Length of name length 
    *contents.s         ; Ptr to allocated data contents 
    contentslength.l    ; Length of contents field 
    *buffer.s           ; Ptr to allocated buffer contents 
  ...
  Structure curl_version_info_data
    ...
    *version.s          ; LIBCURL_VERSION 
    version_num.l       ; LIBCURL_VERSION_NUM 
    *host.s             ; OS/host/cpu/machine when configured 
    features.l          ; bitmask, see defines below 
    *ssl_version.s      ; human readable string 
    ssl_version_num.l   ; not used anymore, always 0 
    *libz_version.s     ; human readable string 
